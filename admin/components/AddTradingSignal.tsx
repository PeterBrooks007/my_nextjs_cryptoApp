...
const AddTradingSignal = () => {
  ...
  const { addTradingSignal, isAddingTradingSignal } = useTradingSignals();
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    if (!profileImage) {
      return toast.error("Please add a Signal photo");
    }
    ...
    await addTradingSignal(formData); // ✅ triggers mutation + refetch
      ...
      <form id="form-rhf-demo" onSubmit={form.handleSubmit(onSubmit)}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use this form to add a new trading Signal
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold">Add Signal Photo</h3>
          ...
          <CardFooter>
            <Button
              disabled={isAddingTradingSignal}
              className="w-full"
              type="submit"
            >
              {isAddingTradingSignal && <Spinner />}
              Add Trading Signal
            </Button>
          </CardFooter>
        </Card>
