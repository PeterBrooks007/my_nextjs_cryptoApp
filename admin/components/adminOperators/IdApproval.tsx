...
import { useIdApproval } from "@/hooks/useAdminOperators";
...
const IdApproval = () => {
  ...
  const { mutate, isPending } = useIdApproval(id);
  ...
  return (
    <div className="mx-3 sm:mx-4">
      ...
      <Card className="p-4 mt-4 gap-2">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <p className="font-semibold">View Uploaded IDs</p>
          </div>
          <Button onClick={() => setOpenUploadedId(true)}>View Proof</Button>
        </div>
      </Card>

      {/* APPROVE USER ID SESSION*/}
      <Card className="p-4 mt-4 gap-2">
        <div className="flex justify-between items-center">
          <div className="flex gap-2 items-center">
            <CheckCircle className="text-green-400" />
            <p className="font-semibold">Approve User ID</p>
          </div>
          <Switch
      ...
      <Card className="p-4 mt-4 gap-2">
        ...
        <p className="mt-1">
          Please note this will Dissapprove the user Id and ask user to
          re-upload id
        </p>
      </Card>
      ...
      <Dialog open={openUploadedId} onOpenChange={setOpenUploadedId}>
        <DialogContent className="sm:max-w-[425px] max-h-[90%] overflow-scroll">
          ...
          <div className="h-auto w-full">
            ...
            <Image
              src={
                (singleUser?.idVerificationPhoto?.front &&
                  singleUser?.idVerificationPhoto?.front !== "NOT UPLOADED" &&
                  singleUser?.idVerificationPhoto?.front) ||
          ...
          <div className="h-auto w-full">
            ...
            <Image
              src={
                (singleUser?.idVerificationPhoto?.back &&
                  singleUser?.idVerificationPhoto?.back !== "NOT UPLOADED" &&
                  singleUser?.idVerificationPhoto?.back) ||
                "/qrCode_placeholder.jpg"
              }
              alt=""
