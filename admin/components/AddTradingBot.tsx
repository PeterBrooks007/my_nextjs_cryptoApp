...
const AddTradingBot = () => {
  ...
  const { addTradingBot, isAddingTradingBot } = useTradingBots();
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    await addTradingBot(formData); // ✅ triggers mutation + refetch
      ...
      <form id="form-rhf-demo" onSubmit={form.handleSubmit(onSubmit)}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use this form to add a new trading bot
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold">Add Bot Photo</h3>
          ...
          <CardFooter>
            <Button
              disabled={isAddingTradingBot}
              className="w-full"
              type="submit"
            >
              {isAddingTradingBot && <Spinner />}
              Add Trading Bot
            </Button>
          </CardFooter>
        </Card>
