...
type AddUserNotificationsProps = {
  updateUserNotification: (formData: {
    userId: string;
    notificationData: {
  ...
  setOpenEditNotification: Dispatch<SetStateAction<boolean>>;
  selectedNotification: NotificationType | null;
};

const EditUserNotifications = ({
  updateUserNotification,
  setOpenEditNotification,
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    await updateUserNotification(formData);
  ...
  return (
    <div className=" mx-3 sm:mx-4 ">
      ...
      <form id="form-rhf-demo" onSubmit={form.handleSubmit(onSubmit)}>
        <Card className="mt-3">
          <CardHeader>
            <CardTitle>Edit this Notifications for this User</CardTitle>
